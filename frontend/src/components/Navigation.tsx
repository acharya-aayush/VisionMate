      ...
      <div className="max-w-md mx-auto">
        <ul className="flex items-center justify-around">
          ...
          <li>
            <Link
              to="/faces"
              className={`nav-link ${isActive('/faces') ? 'active' : ''}`}
              aria-current={isActive('/faces') ? 'page' : undefined}
            >
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-scan-face">
